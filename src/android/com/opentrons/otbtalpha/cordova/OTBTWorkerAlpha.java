 ...
 */
public class OTBTWorkerAlpha {

    // Debugging
    private static final String TAG = OTBTWorkerAlpha.class.getSimpleName();
     ...
     */
    public OTBTWorkerAlpha(Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (OTBTWorkerAlpha.this) {
                        switch (mState) {
                            case STATE_LISTEN:
